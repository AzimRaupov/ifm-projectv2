    ...
    <div class="container-lg content-space-b-2 content-space-b-lg-3">
        <ul class="list-inline list-py-2 list-px-1 text-center mb-0">
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Духовность</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Научная сфера</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">It</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Промышленность</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Транспорт и логистика</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Медицина и фармацевтика</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Образование</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Финансы и банковское дело</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Юриспруденция</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Искусство и креативные</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Естественные науки</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Гуманитарные науки</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Социальные науки</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Технические науки</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Компьютерные науки</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Здоровье</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Развитие</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Финансы</span>
            </li>

            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Предпринимательство</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Страхование</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Маркетинг и реклама</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Математика</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">История и археология</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Системное администрирование</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Кибербезопасность</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Аналитика данных</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Дизайн UX/UI</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Тестирование и QA</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Механика</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Электротехника</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Психология и психотерапия</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Мода</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Журналистика</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Телевидение и радио</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Продюсирование и режиссура</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Экология</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">География и геология</span>
            </li>
            <li class="list-inline-item">
                <span class="badge bg-soft-secondary text-dark fs-4 py-2 px-3">Переводы и лингвистика</span>
            </li>
